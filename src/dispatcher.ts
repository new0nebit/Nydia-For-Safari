  ...
  private async interceptWebAuthn(
    ...
    try {
      ...
      const onAction = (
        ...
        return type === 'create'
          ? this.handlePasskeySave(opts as CreationOptions)
          : this.handleGetAssertion(opts as RequestOptions, selectedCredentialId);
      };
          ...
          const response = {
            ...
            response: {
              ...
              ...(() => {
                ...
                if (pk) extras.publicKeyDER = base64UrlEncode(pk);
