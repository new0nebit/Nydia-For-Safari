  ...
  try {
    switch (message.type) {
      ...
      case 'findCredential': {
        ...
        // Case 1: user already selected — selectedUniqueId is a uniqueId
        ...
        // Case 2: allowCredentials provided — compute uniqueId per entry, direct DB lookup
        ...
        // Case 3: discoverable — find by rpId via metadata only
